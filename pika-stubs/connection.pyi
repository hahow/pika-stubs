...
class Parameters:
    ...
    @credentials.setter
    def credentials(self, value: credentials_.VALID_TYPES): ...
    @property
    ...
    @heartbeat.setter
    def heartbeat(self, value: Optional[Union[numbers.Integral, _OnHeartbeatTimeoutCallback]]) -> None: ...
    @property
    def host(self) -> str: ...
    @host.setter
    ...
    def stack_timeout(self, value: Optional[numbers.Real]): ...
    @property
